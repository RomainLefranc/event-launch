...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div className={cn("bg-black fixed inset-0 transition-opacity duration-1000", showBackground ? "opacity-0" : "opacity-100")} />

      <div className="max-w-7xl mt-10 md:mt-20 mx-auto">
        <div className="flex flex-col items-center relative z-10">
          <h1 className="text-5xl  lg:text-7xl max-w-3xl text-center leading-snug mb-12">
          ...
          <p className="mb-8 text-center">
            ...
            <Image alt="Builder.io logo" className="inline-block ml-1 -mt-1" width={100} height={20} src={assets.builder} />
            {" + "}
            <Image alt="Figma logo" className="inline-block mx-1" width={55} height={20} src={assets.figmatwo} />
          </p>
          <div className="mb-8">
            <button
              ref={buttonRef}
